...
public class EdgeWeightedDiGraphTests {
    ...
    public void testEdgeCreation() {
        ...
        for(int i = 0; i < 9; i++) {
            assertEquals((Double)d.edgeWeight(i, i+1), (Double)1.1);
        }
    }
    ...
    public void testDirectedEdges() {
        EdgeWeightedDiGraph d = new EdgeWeightedDiGraph(10);
        d.addEdge(1, 2, 1.1);
        assertEquals((Double)d.edgeWeight(1,2), (Double)1.1);
    ...
    public void testVariableEdgeWeights() {
        ...
        for(int i = 0; i < 9; i++) {
            assertEquals((Double)d.edgeWeight(i, i+1), (Double)(i/10.0));
        }
    }
    ...
    public void testNegativeEdgeWeights() {
        ...
        for(int i = 0; i < 9; i++) {
            assertEquals((Double)d.edgeWeight(i, i+1), (Double)(-i - 0.5));
        }
    }
    ...
    public void testReplaceEdge() {
        ...
        for(int i = 0; i < 9; i++) {
            assertEquals((Double)d.edgeWeight(i, i+1), (Double)(i/2.0));
        }
    }
    ...
    public void testOneAdjacent() {
        ...
        assertEquals((Integer)it.next(), (Integer)9);
    }
